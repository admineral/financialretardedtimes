...
import { ArchiveDateTimeline, filterDatesByRange, type ArchiveTimeRange } from './ArchiveDateTimeline'
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 min-h-[520px]">
        <TerminalCard
          ...
          subtitle="GitHub-style · full spectrum"
        ...
        <div className="xl:col-span-5 flex flex-col gap-4">
          <TerminalCard title="Range Analytics" subtitle={`${rangeMetrics.from} → ${rangeMetrics.to}`}>
            ...
            <MessageVolumeChart data={chartSeriesFromDates(filteredDates)} heightClass="h-[140px]" />
          </TerminalCard>
